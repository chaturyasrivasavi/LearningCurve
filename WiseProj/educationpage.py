...
class EducationPage:
    def __init__(self):
        ...
        self.img_cse = PhotoImage(file='CSE.png')
        self.img_it = PhotoImage(file='IT.png')
        self.img_ai = PhotoImage(file='AI.png')
        self.img_ece = PhotoImage(file='ECE.png')
        self.img_eee = PhotoImage(file='EEE.png')
        self.img_ce = PhotoImage(file='CE.png')
        self.img_me = PhotoImage(file='ME.png')
